package com.daferpi.kmmspacelaunches.shared.cache.shared

import com.daferpi.kmmspacelaunches.shared.cache.AppDatabase
...
import comdaferpikmmspacelaunchesshared.cache.Rocket
import comdaferpikmmspacelaunchesshared.cache.SelectAllLaunchesInfo
import kotlin.Any
...
private class AppDatabaseQueriesImpl(
  ...
  override fun <T : Any> selectAllLaunchesInfo(mapper: (
    ...
    name: String?,
    type: String?
  ) -> T): Query<T> = Query(2110126817, selectAllLaunchesInfo, driver, "AppDatabase.sq",
  ...
  override fun insertLaunch(
    ...
    notifyQueries(-1065103905, {database.appDatabaseQueries.selectAllLaunchesInfo})
  }
  ...
  override fun insertRocket(
    ...
    notifyQueries(-880938752, {database.appDatabaseQueries.selectRocketById +
        database.appDatabaseQueries.selectAllLaunchesInfo})
  }

  override fun removeAllLaunches() {
    driver.execute(385964811, """DELETE FROM Launch""", 0)
    notifyQueries(385964811, {database.appDatabaseQueries.selectAllLaunchesInfo})
  }

  override fun removeAllRockets() {
    driver.execute(-790154379, """DELETE FROM Rocket""", 0)
    notifyQueries(-790154379, {database.appDatabaseQueries.selectRocketById +
        database.appDatabaseQueries.selectAllLaunchesInfo})
  }
  ...
  private inner class SelectRocketByIdQuery<out T : Any>(
    ...
    override fun execute(): SqlCursor = driver.executeQuery(264239989, """
    |SELECT * FROM Rocket
    |WHERE id = ?
    """.trimMargin(), 1) {
      bindString(1, id)
